...
export default function WhatsAppButton() {
  ...
  useEffect(() => {
    // Chama atenção a cada 9s, por um instante — não fica pulsando o tempo todo.
  ...
  return (
    <a
      ...
      className={`fixed bottom-25 right-4 z-40 flex items-center justify-center w-14 h-14 rounded-full bg-teal text-white shadow-lg hover:scale-105 active:scale-95 transition-transform cursor-pointer ${
        isPulsing ? "wa-pulse" : ""
      }`}
    >
